...
--gin_bindings="Config.data_dir = '/home/ubuntu/hjw/Datasets/llnerf-dataset/wall'" \
--gin_bindings="Config.checkpoint_dir = './nerf_results/llnerf/wall'" \
...
--gin_bindings="Config.logfile = 'logs/wall.txt'" \
--logtostderr \
...
--gin_bindings="Config.batch_size = 1024" \
--gin_bindings="Config.render_dir = './nerf_results/llnerf/wall/render/'" \
